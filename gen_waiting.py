...
Original file is located at
    https://colab.research.google.com/drive/1Vmiiq2pt1otvu3LrQ8bcTb5dRoUOvad1
"""
'''
!unzip "/content/PythonPDEVS-master (3.11).zip" -d /content/PythonPDEVS

# Commented out IPython magic to ensure Python compatibility.
# %cd /content/PythonPDEVS/src
!python setup.py install

from pypdevs.DEVS import *
print("✅ PyPDEVS import 성공!")
'''
